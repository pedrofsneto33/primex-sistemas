            ...
            >
              <Card className="h-full bg-primex-dark border-primex-gray-800 hover:border-primex-green transition-all duration-300 group">
                <CardContent className="p-6 flex flex-col items-center text-center h-full">
                  <div className="w-24 h-24 rounded-full bg-primex-green/10 flex items-center justify-center text-primex-green mb-6 group-hover:scale-105 transition-transform border border-primex-green/20">
